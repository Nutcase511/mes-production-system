...
const PageContent = () => {
  return (
    <>
      <Card className="backdrop-blur-xl bg-blue-500/10 border-2 rounded-xl overflow-hidden p-4 mb-4" style={{ borderColor: 'rgba(59, 130, 246, 0.3)' }}>
        <div className="flex justify-between items-start gap-4">
          <div className="flex-1">
            <ViewFilter 
              filters={[
                { key: 'scrap-code', name: '报废单号' },
                { key: 'material-code', name: '物料编码' },
                { key: 'material-name', name: '物料名称' },
                { key: 'status', name: '状态' },
              ]} 
          ...
          <div className="flex gap-2 items-center pt-4">
            ...
            <CreateAction modelId={tableId}><Button className="bg-gradient-to-r from-blue-400 to-cyan-400 hover:from-blue-500 hover:to-cyan-500 shadow-[0_0_15px_rgba(59,130,246,0.5)]">+ 新建报废申请</Button></CreateAction>
          </div>
        </div>
      </Card>
      <ViewDataTable 
      ...
      >
        <TableColumn name="scrap-code" title="报废单号" width={150} />
        ...
        <TableColumn name="quantity" title="报废数量" width={100} />
        <TableColumn name="unit" title="单位" width={80} />
        <TableColumn name="warehouse" title="所属仓库" width={120} />
        <TableColumn name="reason" title="报废原因" width={200} />
