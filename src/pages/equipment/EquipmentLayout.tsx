...
import { ChevronDown, Monitor, Wrench, Settings } from 'lucide-react'
  ...
  const menuCategories = [
    {
      ...
      items: [
        { path: '/equipment/monitor', label: '设备监控' },
        { path: '/equipment/list', label: '设备列表' },
      ]
    },
    {
      id: 'maintenance',
      ...
      items: [
        { path: '/equipment/maintenance', label: '维护保养' },
        { path: '/equipment/inspection', label: '设备点检' },
      ]
    },
    {
      id: 'tool',
      ...
      items: [
        { path: '/equipment/gauge', label: '量具检验' },
        { path: '/equipment/tool-maintenance', label: '工具维护' },
      ]
    }
  ]
