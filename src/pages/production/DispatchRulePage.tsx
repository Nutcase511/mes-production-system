...
const DispatchRuleContent: React.FC = () => {
  return (
    <>
      {/* 过滤器卡片 */}
      ...
      >
        <TableColumn name="rule-name" title="规则名称" width={180} />
        <TableColumn name="rule-type" title="规则类型" width={120} />
        <TableColumn name="priority" title="优先级" width={80} />
        <TableColumn name="description" title="描述" width={200} />
...
export function DispatchRulePage() {
  return (
...
export default DispatchRulePage
